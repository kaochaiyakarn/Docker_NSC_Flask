...
export class UploadfileComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    console.log(this.details['identity']['sex'])
    ...
    if (this.userInformation['sex'] == 'male'){
      this.textShow = 'Mr.' + this.userInformation['first_name'] + ' ' + this.userInformation['last_name']
    }
    if (this.userInformation['sex'] == 'female'){
      this.textShow = 'Miss.' + this.userInformation['first_name'] + ' ' + this.userInformation['last_name']
    }
...
getMockupData(){
  ...
  */
  ...
  this.auth.mockupdata().subscribe(
    res =>{
